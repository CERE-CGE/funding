...
% Model enhancement
The model will have to be modified in order to incorporate the new detailed data for the Swedish energy system
...
\subsubsection{Timetable, implementation and project organisation}
...
The research will be also present on the international conferences to get the feedbacks from the experts.
